...
/obj/item/organ/internal/brain_holder
	...
	parent_organ = BP_HEAD
	vital = 1
	var/obj/item/brain_interface/stored_mmi = /obj/item/brain_interface
...
/obj/item/organ/internal/brain_holder/Initialize(mapload, var/internal)
	. = ..()
	if(ispath(stored_mmi))
		stored_mmi = new stored_mmi(src)
...
/obj/item/organ/internal/brain_holder/proc/update_from_mmi()
	...
	if(!stored_mmi.holding_brain || !owner)
		return

	name = stored_mmi.name
	desc = stored_mmi.desc
	appearance = stored_mmi
...
/obj/item/organ/internal/brain_holder/proc/transfer_and_delete()
	if(stored_mmi?.holding_brain?.brainmob)
		. = stored_mmi
...
/obj/item/organ/internal/brain_holder/robotic
	stored_mmi = /obj/item/brain_interface/robotic

/obj/item/organ/internal/brain_holder/organic
	stored_mmi = /obj/item/brain_interface/organic
