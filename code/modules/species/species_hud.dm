/datum/hud_data
	...
	var/list/gear = list(
		"i_clothing" =   list("loc" = ui_iclothing, "name" = "Upper Uniform", "slot" = slot_w_uniform_str, "state" = "center", "toggle" = 1),
		"pants" =        list("loc" = ui_lclothing, "name" = "Lower Uniform", "slot" = slot_pants_str,     "state" = "pants",  "toggle" = 1),
