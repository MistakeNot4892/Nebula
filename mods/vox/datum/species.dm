/datum/species/vox
	...
	icobase =         'mods/vox/icons/body.dmi'
	deform =          'mods/vox/icons/body.dmi'
	husk_icon =       'mods/vox/icons/husk.dmi'
	damage_overlays = 'mods/vox/icons/damage_overlay.dmi'
	damage_mask =     'mods/vox/icons/damage_mask.dmi'
	blood_mask =      'mods/vox/icons/blood_mask.dmi'
...
/datum/species/vox/armalis
	...
	icobase =         'mods/vox/icons/armalis_body.dmi'
	deform =          'mods/vox/icons/armalis_body.dmi'
	husk_icon =       'mods/vox/icons/armalis_husk.dmi'
	damage_overlays = 'mods/vox/icons/damage_overlay_armalis.dmi'
	damage_mask =     'mods/vox/icons/damage_mask_armalis.dmi'
	blood_mask =      'mods/vox/icons/blood_mask_armalis.dmi'
...
/mob/living/simple_animal/hostile/voxslug/proc/check_friendly_species(var/mob/living/carbon/human/H)
	return (istype(H) && H.species.get_bodytype == BODYTYPE_VOX) || ..()

/datum/robolimb/vox
	company = "Arkmade"
	icon = 'mods/vox/icons/primalis_cyberlimbs.dmi'
...
/datum/robolimb/vox/crap
	company = "Improvised"
	icon = 'mods/vox/icons/improvised_cyberlimbs.dmi'
...
/decl/emote/audible/vox_shriek
	...
	emote_sound = 'mods/vox/sounds/shriek1.ogg'
